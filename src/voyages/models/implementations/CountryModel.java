...
public class CountryModel implements IModel {
    ...
    private static String UPDATE = "UPDATE " + TABLE + " SET Name = ? WHERE CountryId = ?";
    
    private static String DELETE = "DELETE FROM " + TABLE + " WHERE CountryId = ?";
