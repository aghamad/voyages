...
public class CityModel implements IModel {
    ...
    private static String UPDATE = "UPDATE " + TABLE + " SET Name = ?, CountryId = ? WHERE CityId = ?";

    
    private static String DELETE = "DELETE FROM " + TABLE + " WHERE CityId = ?";
    ...
    public int update(IModel model) throws DAOException {
        try {
            ...
            try(PreparedStatement updateStatement = getConnexion().getConnection().prepareStatement(UPDATE)) {
            	updateStatement.setString(1, city.Name);
            	updateStatement.setLong(2, city.CountryId);
            	updateStatement.setLong(3, city.CityId);
    ...
    public int create(IModel model) throws DAOException {
        try {
            ...
            try(
            	...
            	createStatement.setString(1, city.Name);
            	createStatement.setLong(2, city.CountryId);
