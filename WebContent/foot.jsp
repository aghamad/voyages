...
<footer style="background-image: url('pic/footer/footer-bg.jpg')" class="footer footer-fixed">
    ...
    <div class="row pb-500 pb-md-40 ">
      ...
      <div class="col-md-3 col-sm-6 mb-sm-30">
        <div class="widget-footer">
          <h4 style="color:orange;">Latest Tweets</h4>
  ...
  <div class="copyright mt-50"> 
    <div class="container">
      <div class="row">
        <div class="col-sm-6">
          <p>Copyright 2016 <span>Voyages Inc.</span> &nbsp;&nbsp;|&nbsp;&nbsp; All Rights Reserved</p>
        </div>
        <div class="col-sm-6 text-right"><a href="<c:url value="/products"/>" class="footer-nav">Home</a><a a href="<c:url value="/products"/>" class="footer-nav">Shop</a><a href="mailto:support.voyagesinc@example.com" class="footer-nav">Contacts</a></div>
      </div>
    </div>
  </div>
  <!-- end copyright-->
